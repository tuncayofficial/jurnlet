...
export function Welcome() {
  return (
    <div className="flex flex-col justify-center items-center h-full">
        ...
        { /** Intro */ }
        <section className="intro min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-200 to-blue-200 p-6 rounded-md">
          <div className="container max-w-4xl mx-auto text-center">
        {/* Logo */}
        <img 
          src={logo} 
          alt="Platform Logo"
          className="mt-12 md:mt-0 w-64 h-64 mx-auto mb-12 rounded-full shadow-md shadow-gray-800 transform hover:scale-105 transition-transform duration-300"
        />
        ...
        <Suspense fallback={<p className="text-gray-600 text-lg">Loading...</p>}>
          <div className="hidden w-100 h-50 m-auto md:block md:absolute md:top-140 md:left-268 md:w-80 md:h-80">
            <Lottie 
              animationData={ArrowStraight} 
              loop={true}
              className="drop-shadow-xl"
            />
          </div>
