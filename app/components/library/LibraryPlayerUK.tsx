...
import { audio } from "framer-motion/client";
    ...
    export default function LibraryPlayerUK() {
        ...
        const findUK = (audioLink: string[]): string | undefined => {
            return audioLink.find(link => link.includes("-uk."));
          };
        ...
        return (
            <div className="flex mx-6 flex-col items-center justify-center p-6 bg-gray-100 rounded-lg shadow-md">
                {/* Audio Player Controls */}
                <span className="bg-indigo-500 font-bold rounded-3xl my-2 mb-10 p-2 px-5 uppercase">British</span>
